...
include '../controller/profile_logout-delete.php';
include '../controller/profile_pfp-bio.php'; 
?>
                    ...
                    <div class="pfpdeets-parent">
                        <div class="pfpdeets">
                            <div class="buttons-container">
                                <a href="../view/user-reservations.php" class="profile-link">My Reservations</a>
                                <a href="../view/user-donations.php" class="profile-link">My Donations</a>
                            </div>
